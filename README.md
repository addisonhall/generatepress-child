...
- `security.php`: Customize your own content security policy! Also includes additional HTTP headers. More about this part on [YouTube](https://www.youtube.com/watch?v=R2dtj7tyUL0).
